...
export default function Navbar() {
  ...
  border border-white/20">
                ...
                <nav className="hidden lg:flex items-center gap-10 font-semibold text-white text-2xl">
                    ...
                    <button onClick={() => handleNavigation("/components/pages/news")}>
                        NEWS
                    </button>
                </nav>
                ...
                <div className="hidden lg:flex items-center gap-4">
                    <button className="text-2xl flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-full font-semibold transition">
                        More Info
            ...
            {isOpen && (
                <div className="absolute top-24 w-[95%] max-w-7xl bg-white rounded-3xl shadow-xl p-6 lg:hidden">
                    <div className="flex flex-col gap-6 font-semibold text-gray-800">
                        ...
                        <button onClick={() => handleNavigation("/news")}>
                            NEWS
                        </button>
                    </div>
                </div>
